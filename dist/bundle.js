...
var html = htm_module.bind(v);
var AusDieMausState = /** @class */ (function () {
    function AusDieMausState() {
        this.rows = new Array();
        this.rows[0] = 0; //max 3
        this.rows[1] = 0; //max 5
        this.rows[2] = 0; //max 6
    ...
    return AusDieMausState;
}());
var AusDieMausBoard = /** @class */ (function (_super) {
    src_extends(AusDieMausBoard, _super);
    function AusDieMausBoard() {
        var _this = _super.call(this) || this;
        _this.ausDieMausState = new AusDieMausState();
        return _this;
    }
    Object.defineProperty(AusDieMausBoard.prototype, "ausDieMausState", {
        get: function () {
    ...
    AusDieMausBoard.prototype.render = function (_a, _b) {
        var _this = this;
        var updateAusDieMausState = _a.updateAusDieMausState;
        var _c = _b.ausDieMausState, ausDieMausState = _c === void 0 ? this.ausDieMausState : _c;
        updateAusDieMausState.subscribe(function (ausDieMausState) {
            _this.ausDieMausState = ausDieMausState;
        });
        var htmFor = function (times, cb) {
        ...
        return html(templateObject_3 || (templateObject_3 = src_makeTemplateObject(["\n            ", "\n        "], ["\n            ",
            "\n        "])), ausDieMausState.rows.map(function (row) { return html(templateObject_2 || (templateObject_2 = src_makeTemplateObject(["\n                <div class='row'>\n                    ", "\n                </div>\n            "], ["\n                <div class='row'>\n                    ",
            "\n                </div>\n            "])), htmFor(row, function () { return html(templateObject_1 || (templateObject_1 = src_makeTemplateObject(["\n                        <div class='bubble'>\n\n                        </div>\n                    "], ["\n                        <div class='bubble'>\n\n                        </div>\n                    "]))); })); }));
    };
    return AusDieMausBoard;
}(d));
var RenderGame = /** @class */ (function () {
    function RenderGame() {
        this.updateAusDieMausState = new Subject();
    }
    RenderGame.prototype.render = function () {
        O(html(templateObject_4 || (templateObject_4 = src_makeTemplateObject(["<", " updateAusDieMausState=", " />"], ["<", " updateAusDieMausState=", " />"])), AusDieMausBoard, this.updateAusDieMausState), document.body);
    };
    return RenderGame;
}());
var PlayGame = /** @class */ (function () {
    function PlayGame() {
    ...
    PlayGame.prototype.training = function () {
        return src_awaiter(this, void 0, void 0, function () {
            var helper, newState, newStateToReaction;
            return src_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!!helper.checkIfFinished(this.activeState)) return [3 /*break*/, 3];
                        console.log('new move');
                        newState = helper.getValidMove(this.activeState);
                        newStateToReaction = { state: clone_default()(this.activeState), reaction: clone_default()(newState) };
...
var Helper = /** @class */ (function () {
    function Helper() {
        this.maxStates = [3, 5, 6, 6, 5, 3];
    }
    Helper.prototype.checkIfFinished = function (state) {
        var _this = this;
        var isFinished = true;
        state.rows.forEach(function (row, i) {
            if (row < _this.maxStates[i]) {
                isFinished = false;
            }
        });
        if (isFinished) {
    ...
    Helper.prototype.getValidMove = function (state) {
        var randRow = this.getRandomRow();
        var randomIncrease;
        var newState = clone_default()(state);
    ...
    Helper.prototype.getRandomRow = function () {
        return Math.floor(Math.random() * Math.floor(6));
    };
    Helper.prototype.getRandomIncrease = function (row, state) {
        var maxIncrease = this.getMaxIncrease(row, state);
        if (maxIncrease < 1) {
            return 0;
        }
        return Math.floor(Math.random() * Math.floor(maxIncrease)) + 1; // between one and the max number itself
    };
    Helper.prototype.getMaxIncrease = function (row, state) {
        return this.maxStates[row] - state.rows[row];
    };
    Helper.prototype.checkIfMoveValid = function (state, lastState) {
        if (JSON.stringify(state.rows) === JSON.stringify(lastState.rows)) {
            return false;
        }
        return this.checkMaxs(state.rows);
    };
    Helper.prototype.checkMaxs = function (vals) {
        var _this = this;
        vals.forEach(function (val, i) {
            if (!(val <= _this.maxStates[i])) {
                return false;
            }
        });
        return true;
...
document.addEventListener("DOMContentLoaded", function () {
    var loadTraining = function () { return src_awaiter(void 0, void 0, void 0, function () {
        var newGame;
        return src_generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    newGame = new PlayGame();
                    return [4 /*yield*/, newGame.training()];
                case 1:
                    _a.sent();
